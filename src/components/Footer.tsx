...
export function Footer() {
  return (
    <footer className="dark-section bg-dark text-dark-text">
      ...
      <div className="overflow-hidden border-t border-dark-line px-6 py-10 sm:px-10">
        {/* Sehr lange Firmennamen ggf. Schriftgröße hier anpassen. */}
        <p className="font-display select-none whitespace-nowrap text-[16vw] font-bold uppercase leading-[0.82] tracking-tight text-dark-text/95 sm:text-[9vw]">
          {company.name}
        </p>
      </div>
    </footer>
