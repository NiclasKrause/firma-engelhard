  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-50 border-b border-line bg-bg/95 backdrop-blur-sm">
        <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-6 px-6 py-3 sm:px-10">
        ...
        {menuOpen ? (
          ...
          >
            ...
            >
              ...
              <a href={`mailto:${company.email}`} className="text-sm text-dark-muted">
                {company.email}
              </a>
            </motion.div>
          </motion.div>
