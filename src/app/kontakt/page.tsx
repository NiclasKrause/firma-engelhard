...
export const metadata: Metadata = {
  title: "Kontakt",
  description: `Sprechen Sie mit ${company.name} über Ihr Vorhaben.`,
};
  ...
  return (
    <section className="dark-section bg-dark px-6 pb-28 pt-32 text-dark-text sm:px-10 sm:pb-36 sm:pt-40">
      <h1 className="font-display font-bold uppercase leading-[0.98] tracking-tight text-[clamp(2.6rem,9vw,7rem)]">
        <MaskReveal trigger="mount" lines={[...content.pages.kontakt.lines]} />
      </h1>
      <Reveal delay={0.2}>
        <p className="mt-6 max-w-md text-lg text-dark-muted">{content.pages.kontakt.sub}</p>
      </Reveal>
